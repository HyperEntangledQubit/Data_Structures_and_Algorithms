...
class TestAnagram():
    ...
    def test_Anagram_frequency_method_works(self):
        assert False == self.anagram.isAnagram("dog", "parrot")
    ...
    def test_isAnagram_uses_correct_method_to_find_anagram(self):
        ...
        assert False == self.anagram.isAnagram("fluffy", "dog")  # Default is frequency method


    # Verify that generateAnagram method works as expected.
    @pytest.mark.skip(reason = "TODO - Implement this unit test as Issue number 14")
